import { Users, Building2, ListTree, Route, Printer, CalendarClock, DatabaseBackup, Upload } from 'lucide-react';
...
export const ADMIN_SIDEBAR: NavItem[] = [
  ...
  { to: '/admin/import',          icon: Upload,   label: 'CSV-Import' },
  { to: '/admin/backup',          icon: DatabaseBackup, label: 'Datensicherung' },
];
